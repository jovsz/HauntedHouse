...
const walls = new THREE.Mesh(
    ...
    new THREE.MeshStandardMaterial({
        ...
        // roughness: bricksRoughnessTextures,
    })
)
...
const floor = new THREE.Mesh(
    ...
    new THREE.MeshStandardMaterial({
        ...
        // roughness: grassRoughnessTextures
    })
)
...
scene.add(ghosts1, ghosts2, ghosts3)
...
const tick = () => {
    ...
    ghosts3.position.y = Math.sin(elapsedTime * 4) + Math.sin(elapsedTime * 2.5)
